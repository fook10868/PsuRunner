...
<div class="slide-one-item home-slider owl-carousel">
    ...
    <?php 
$sql_running_event = "SELECT * FROM tbl_running_event  ORDER BY tbl_running_event.id_running_event ASC"; 
...
?>
    ...
    <div class="site-blocks-cover inner-page"
        style="background-image: url(blackoffice/photo_running_event/<?=$result_running_event['photo_running_event'];?>);"
...
<div class="site-section" style="font-family: 'Kanit', sans-serif;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="site-section-heading text-center">งานวิ่งเร็วๆนี้..</h2>
            </div>
        </div>
        <br />
...
?>
                        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                            <div class="media-with-text mb-5">
                                <div class="mb-4">
                                    <a
                                        href="run_detail.php?id_running_event=<?php echo $result_running_event['id_running_event'];?>">
                                        <img src="blackoffice/photo_running_event/<?=$result_running_event['photo_running_event'];?>"
