...
if(move_uploaded_file($_FILES["map_running_event"]["tmp_name"],"map_running_event/".$new_name1)) //อัพไฟล์ขึ้น
 ...
 $sql_running_event = "INSERT INTO tbl_running_event (id_running_event, id_user, id_faculty,name_running_event, date_running_event, photo_running_event, shirtphoto_running_event,map_running_event, detail_running_event) VALUES (NULL,'$_POST[id_user]','$_POST[id_faculty]', '$_POST[name_running_event]','$_POST[date_running_event]','$photo_running_event','$shirtphoto_running_event','$map_running_event','$_POST[detail_running_event]')"; 
